# -*- coding: utf-8 -*-
"""
Created on Tue Aug 17 15:57:59 2021
...
filename = ("V:\SEM 7\Personal Intern\Docsup Intern\Lifestyle_Books.csv")
...
page=1
while page != 4:
      myurl = f'https://www.pdfdrive.com/category/19/p{page}'
...
# create csv file of all products
      for books in bookshelf:
          ...
          cv=books.findAll("img",{"class":"img-zoom"})
          for cover in cv:
              cu=cover.get('src')
